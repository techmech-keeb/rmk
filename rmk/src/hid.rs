...
pub(crate) const RESOLUTION_MULTIPLIER_MAX: u8 = 30;
...
/// 0x48, logical 0..=1, physical 1..=30), per HID Usage Tables' rule that the
        ...
        (collection = PHYSICAL, usage = POINTER) = {
            ...
            (collection = LOGICAL, usage_page = GENERIC_DESKTOP, usage = WHEEL) = {
                (report_id = 0x05, usage = 0x48, logical_min = 0, logical_max = 1,
                 physical_min = 1, physical_max = 30) = {
            ...
            (collection = LOGICAL, usage_page = CONSUMER, usage = AC_PAN) = {
                (report_id = 0x05, usage_page = GENERIC_DESKTOP, usage = 0x48, logical_min = 0,
                 logical_max = 1, physical_min = 1, physical_max = 30) = {
...
mod resolution_multiplier_descriptor_tests {
    ...
    fn composite_descriptor_bytes_are_pinned() {
        let expected: [u8; 182] = [
            ...
            0x02, 0x09, 0x48, 0x85, 0x05, 0x15, 0x00, 0x25, 0x01, 0x35, 0x01, 0x45, 0x1e, 0xb1, 0x02, 0x35, 0x00, 0x45,
            0x00, 0x09, 0x38, 0x85, 0x02, 0x17, 0x81, 0xff, 0xff, 0xff, 0x25, 0x7f, 0x81, 0x06, 0xc0, 0x05, 0x0c, 0x0a,
            0x38, 0x02, 0xa1, 0x02, 0x05, 0x01, 0x09, 0x48, 0x85, 0x05, 0x15, 0x00, 0x25, 0x01, 0x35, 0x01, 0x45, 0x1e,
